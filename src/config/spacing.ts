...
export const CONTAINER_HOR_PADDING = horizontalScale(22);
const CONTAINER_VER_PADDING = verticalScale(25);
...
export const HEADER_PADDING_BOTTOM = 25;
export const HEADER_PADDING_TOP = 10 + STATUS_BAR_HEIGHT;
